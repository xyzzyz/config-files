...
-- Register widget
vicious.register(memwidget, vicious.widgets.mem, "mem $2MB/$3MB", 13)
...
--  vicious.register(batwidget, vicious.widgets.bat, "a$2", 61, "BAT0")
...
vicious.register(volwidget, vicious.widgets.volume, "vol $1%", 120, "Master")
...
for s = 1, screen.count() do
    ...
    mywibox[s].widgets = {
        ...
        s == 1 and gmailwidget or nil,
        s == 1 and spacer or nil,
        s == 1 and memwidget or nil,
        s == 1 and spacer or nil,
        s == 1 and cpuwidget or nil,
        s == 1 and spacer or nil,
        s == 1 and uptimewidget or nil,
        mytasklist[s],
