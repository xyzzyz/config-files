...
(custom-set-variables
 ...
 '(haskell-mode-hook
   (quote
    (turn-on-haskell-indentation capitalized-words-mode turn-on-haskell-doc-mode turn-on-haskell-decl-scan)))
 '(hl-paren-background-colors nil)
 '(hl-paren-colors
   (quote
    ("red1" "orange1" "yellow1" "green1" "cyan1" "blue1" "magenta1" "firebrick1" "RosyBrown1")))
 ...
 '(prolog-program-name
   (quote
    (((getenv "EPROLOG")
     ...
     (eclipse "eclipse")
     (mercury nil)
     (sicstus "/home/dodek/sshfs/students/usr/local/opt/sicstus4.2.0/bin/sicstus")
     (swi "swipl")
     (gnu "gprolog")
     (t "swipl"))))
 '(prolog-system (quote sicstus))
 ...
 '(semantic-default-submodes
   (quote
    (global-semantic-stickyfunc-mode global-semantic-idle-completions-mode global-semantic-idle-scheduler-mode global-semanticdb-minor-mode global-semantic-idle-summary-mode)))
